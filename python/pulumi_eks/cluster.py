...
class Cluster(pulumi.ComponentResource):
    def __init__(__self__,
                 ...
                 encrypt_root_bock_device: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] encrypt_root_bock_device: Encrypt the root block device of the nodes in the node group.
        ...
        if opts.id is not None:
            ...
            __props__['encrypt_root_bock_device'] = encrypt_root_bock_device
